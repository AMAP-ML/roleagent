...
export MASTER_PORT="${MASTER_PORT:-$((29800 + RANDOM % 100))}"
...
EXP_LOG_NAME="role_agent_webshop_gigpo_wia_aiw"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/workspace/wxc/Agent/models/Qwen2.5-1.5B-Instruct \
    ...
    trainer.project_name='RoleAgent_webshop' \
